...
def GetWantBuyAndOperation():
    ...
    for i in range(0, 9, 2):
        ...
        if num == WinningNumList[1][i]:
            print("新疆" + position + "位 " + num + " 符合一组" + str(WantBuy_1))
            Operation(WantBuy_1, i)
        else:
            print("新疆" + position + "位 " + num + " 符合两组" + str(WantBuy_1) + '和' + str(WangBuy_2))
            Operation(WantBuy_1, i)
